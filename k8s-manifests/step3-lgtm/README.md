...
### 3-A. Monitoring VM (192.168.56.30)에서 실행

```bash
# 1. 파일 복사 (개발 머신 → monitoring VM)
scp -r k8s-manifests/step3-lgtm/monitoring-vm/* clouddx@192.168.56.30:/opt/monitoring/
...
Grafana UI (`http://192.168.56.30:3000`) → Dashboards → Import:

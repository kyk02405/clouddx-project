    ...
    return (
        ...
        >
            ...
            >
                <div className={`relative mx-auto ${feature.isPhone ? 'max-w-[280px] sm:max-w-[320px]' : 'max-w-[500px] lg:max-w-none shadow-2xl rounded-2xl overflow-hidden border-[8px] lg:border-[16px] border-zinc-900 bg-zinc-800'}`}>
                    ...
                    <motion.div 
                        ...
                        className="absolute -top-6 -right-6 lg:-top-12 lg:-right-12 h-20 w-20 lg:h-32 lg:w-32 bg-emerald-500/10 dark:bg-emerald-500/20 rounded-full blur-2xl -z-10"
                    />
                </div>
            </motion.div>
            ...
            <div className="flex-1 text-center lg:text-left">
                ...
                >
                    <span className="text-emerald-500 font-black text-sm tracking-[0.2em] uppercase mb-4 block">
                    ...
                    <div className="mt-10 flex flex-wrap justify-center lg:justify-start gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">

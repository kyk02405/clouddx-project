 ...
 * shadcn/ui 스타일에 맞춰 lucide-react에서 아이콘을 가져옵니다.
 * 
 * 사용법:
 * import { Search, User, Heart, X, Star, MessageCircle, Plus, Moon, Sun, Settings, RefreshCw } from "lucide-react";
 * 
 * 또는 이 파일에서:
...
export function HeartIcon({ className, filled }: { className?: string; filled?: boolean }) {
  return (
    <svg fill={filled ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
=======
// lucide-react 아이콘을 re-export하여 기존 코드 호환성 유지
export {
...
>>>>>>> a8645901d1dd00b7b86d1deea6f638eaac104ef7

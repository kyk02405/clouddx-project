                ...
                <form onSubmit={handleLogin}>
                    ...
                    <CardFooter className="flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-3 gap-3 w-full">
                            <Button variant="outline" type="button" className="w-full h-11 bg-white hover:bg-zinc-50 border-zinc-200 text-zinc-900 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 dark:border-zinc-200" onClick={() => window.location.href = "http://localhost:8000/api/v1/auth/google/login"}>
                                <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                                    <path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path>
                                </svg>
                                Google
                            </Button>
                            <Button variant="outline" type="button" className="w-full h-11 bg-[#FEE500] hover:bg-[#FDD835] border-[#FEE500] text-[#191919] dark:bg-[#FEE500] dark:text-[#191919] dark:hover:bg-[#FDD835] dark:border-[#FEE500]" onClick={() => window.location.href = "http://localhost:8000/api/v1/auth/kakao/login"}>
                            ...
                            <Button variant="outline" type="button" className="w-full h-11 bg-[#03C75A] hover:bg-[#02b351] border-[#03C75A] text-white dark:bg-[#03C75A] dark:text-white dark:hover:bg-[#02b351] dark:border-[#03C75A]" onClick={() => window.location.href = "http://localhost:8000/api/v1/auth/naver/login"}>
                                <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

...
### 2026.02 업데이트 (인증 시스템 통합)
- **Role**: 로그인/회원가입, 소셜 로그인(Google, Naver), 실제 API 연동
- **Status**: ✅ Phase 1 완료 및 Phase 2(Auth) 진행 중
...
- [x] **Phase 1**: 랜딩 페이지 및 UI 컴포넌트
- [x] **Phase 2**: 로그인/회원가입 및 인증 로직
- [ ] **Phase 3**: 사용자 대시보드 (내 자산 연동, 포트폴리오 차트)
- [ ] **Integration**: 백엔드 실제 API 연동 고도화

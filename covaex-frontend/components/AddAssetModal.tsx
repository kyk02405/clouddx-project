      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-1 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        <div className="p-7">
          ...
          <div className="grid gap-4">
            {/* Direct Registration */}
            <Link
              href="/user-upload/bulk-register"
            ...
            >
              ...
              <div className="flex-1 pt-1">
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">직접 등록</h3>

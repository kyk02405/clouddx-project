...
import { Bell, Settings, User, LayoutDashboard, Activity, Sun, Moon, Search } from "lucide-react";
...
export default function PortfolioHeader() {
    ...
    return (
        <header className="border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0 sticky top-0 z-50">
